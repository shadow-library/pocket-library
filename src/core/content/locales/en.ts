...
export const en = {
  ...
  reader: {
    ...
    pull: {
      hint: 'Pull up for the next chapter',
      next: 'Keep pulling for next chapter',
      prev: 'Keep pulling for previous chapter',
      releaseNext: 'Release for next chapter',
      releasePrev: 'Release for previous chapter',
    },
